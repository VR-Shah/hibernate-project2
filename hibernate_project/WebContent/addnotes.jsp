...
<html lang="en">
  ...
  <div class="container">
	...
	<input type="hidden" value="insert" name="flag">
	  ...
	  <input type="text" class="form-control" id="exampleFormControlInput1" name="nt" placeholder="enter your task here">
	</div>
	<div class="mb-3">
	  <label for="exampleFormControlTextarea1" class="form-label">Note Description</label>
	  <textarea class="form-control" id="exampleFormControlTextarea1" name="nd" rows="3"></textarea>
	</div>
